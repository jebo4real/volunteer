			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<div class="section_title">welcome to volunteer page</div>
						<div class="section_subtitle">It's the start of an amazing journey</div>
					</div>
				</div>
			</div>
			<div class="row about_row">
				<div class="col-lg-6">
					<div class="about_image"><img src="assets/images/about.jpg" alt=""></div>
				</div>
				<div class="col-lg-6">
